...
<%
//下面是openjweb平台中封装的，用户可自行设置appId和appSecret,对于access_token如果不好获取，
//可在 url中直接输入获取token的连接，获取到json数据后，将token值填到本jsp的tokenId变量，有2小时的可用时间
...
<html>
	...
	<meta id="viewport" name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1; user-scalable=no;" />
		...
		var orderNo="";
            ...
            {
                return "8934e7d15453e97507ef794cf7b0519d";////申请时获取的商户partner key
            ...
            function getPackage()
            {
				...
				var notify_url = "http://www.iartwall.com/portal/apps/b2c/weixinPay.jsp";//这个地址是支付成功后调用的，业务系统需要在这里截获返回的参数，写到自己的业务系统中以记录此订单是否成功付款，及付款银行信息等很多内容，详见支付接口文档。
        ...
        <form name="form1" target="_blank">
            <table border="1">
                <TR><th>公众号ID</th> <th><INPUT value="<%=appId%>" name="appId" id="1"></th>
                    <tr><th>商户ID</th><th><INPUT value="1219345101" name="partnerId" id="2"></th>
